...
`PROJECT-ISSUES/all-issues.md` is the high-level issue inventory.

`PROJECT-ISSUES/issues-details.md` contains the detailed explanation of discovered issues without implementation solutions unless explicitly requested.
